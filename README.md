...
```bash
npm install @onegenui/react @onegenui/core
# or
pnpm add @onegenui/react @onegenui/core
```
...
```tsx
import { JSONUIProvider, Renderer, useUIStream } from '@onegenui/react';
...
```tsx
import { useUIStream } from '@onegenui/react';
